                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3><a href="/dotnet/articles/core">.NET Core のガイド</a></h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3><a href="https://msdn.microsoft.com/library/w0x726c2(v=vs.110).aspx">.NET Framework ガイド</a></h3>
                                                <p><a href="https://msdn.microsoft.com/library/hh425099(v=vs.110).aspx">開始するには</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/hh156542(v=vs.110).aspx">チュートリアル</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/54xbah2z(v=vs.110).aspx">クライアント開発</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="https://developer.xamarin.com/guides/cross-platform/getting_started">開始するには</a></p>
                                                <p><a href="https://developer.xamarin.com/guides/ios">Xamarin.iOS のガイド</a></p>
                                                <p><a href="https://developer.xamarin.com/guides/android/getting_started">Xamarin.Android のガイド</a></p>
                                                <p><a href="https://developer.xamarin.com/guides/xamarin-forms">Xamarin.Forms のガイド</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3><a href="/dotnet/articles/visual-basic">Visual Basic のガイド</a></h3>
                                                <p><a href="/dotnet/articles/visual-basic/getting-started">開始するには</a></p>
                                                <p><a href="/dotnet/articles/visual-basic/walkthroughs">Visual Basic のツアー</a></p>
                                                <p><a href="/dotnet/articles/visual-basic/language-reference">Visual Basic の言語リファレンス</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core の使用</h3>
                                                    <p>ASP.NET Core を使用して最新の Web アプリを構築する方法を説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio 2015 を使用した、ASP.NET Core MVC Web アプリの構築の基礎について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>コンテナーでの ASP.NET アプリ</h3>
                                                    <p>Docker を使用した ASP.NET アプリのデプロイ方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET Azure ドキュメント</h3>
                                                    <p>Web Apps、WebJobs、Cloud Services、および VM などの Azure サービスについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Azure Storage、Cloud Services、Azure Functions などの F# を使用するさまざまな Azure サービスについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>WPF では、開発者が Windows でデスクトップ アプリケーションを構築するための XAML ベースのモデルが用意されています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>MonoGame ライブラリ ドキュメント ハブで、チュートリアルとセットアップ インストラクションを通して、C# を使用してゲームを構築します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
